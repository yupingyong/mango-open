...
namespace Mango.Web.Common
{
    ...
    public class ApiServerConfig
    {
        ...
        /// 获取网站顶部导航数据接口
        /// </summary>
        public static string MainData_GetWebSiteNavigation { get; set; } = "/api/WebSite/Base/navigation";
        /// <summary>
        /// 获取网站基本设置数据接口
        /// </summary>
        public static string MainData_GetWebSiteConfig{ get; set; } = "/api/WebSite/Base/config";
        #endregion
    }
}
